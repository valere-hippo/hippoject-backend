...
public class SprintController {
    ...
    @GetMapping
    public List<SprintResponse> listSprints(@PathVariable Long projectId, @RequestParam(defaultValue = "false") boolean includeArchived) {
        return sprintService.listSprints(projectId, includeArchived);
    }
